...
public class BddAccess {
	...
	private PPE refPPE;
	private static BddAccess bdd = null;
	BddAccess(){
	...
	// Connexion a la BDD
	public static void bddConnect(String bddName) {
		try {
			if(bdd == null) {
				bdd = new BddAccess();
				System.out.println("premier accee à la base de donnee");
			}
			else{
				System.out.println("COMPOSANT BddAccess deja cree ");
			}
